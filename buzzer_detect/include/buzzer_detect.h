...
struct buzzer_detect
{
    ...
    int  (* enable)(struct buzzer_detect *buzzer_pwm);
    int  (* disable)(struct buzzer_detect *buzzer_pwm);
    int  (* write_period)(struct buzzer_detect *buzzer_pwm, int period);
    int  (* write_duty_cycle)(struct buzzer_detect *buzzer_pwm, int duty_cycle);
    void (* release)(struct buzzer_detect *buzzer_pwm);
};
